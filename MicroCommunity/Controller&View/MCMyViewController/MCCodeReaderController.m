...
@interface MCCodeReaderController () <ZBarReaderViewDelegate>
{
...
- (void)qrCodeAction:(id)sender
{
    ...
    //[self presentViewController:readerVController animated:YES completion:nil];
}
