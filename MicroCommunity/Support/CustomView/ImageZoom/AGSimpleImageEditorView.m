...
@interface AGSimpleImageEditorView ()<UIScrollViewDelegate>
...
- (void)initialize
{
    ...
    UIScrollView *scrollV = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - 70)];
    ...
    scrollV.contentSize = CGSizeMake(SCREEN_WIDTH, SCREEN_HEIGHT-30);
...
//    CGFloat x = 0;
//    CGFloat y = 200;
//    CGRect  _cropRect = CGRectMake(x, y, SCREEN_WIDTH, SCREEN_HEIGHT);
//
//    
//    [super drawRect:rect];
